...
def test_like_toggle_returns_the_action_bar(client, htmx, log_in, alice, bob, make_post):
...
def test_like_without_htmx_redirects_to_the_post(client, log_in, alice, bob, make_post):
    post = make_post(alice)
    log_in("bob")
...
def test_save_toggle_updates_the_reading_list(client, htmx, log_in, alice, bob, make_post):
...
def test_comment_fragment_carries_the_out_of_band_swaps(
    client, htmx, log_in, alice, bob, make_post
):
    post = make_post(alice)
    log_in("bob")
...
def test_comment_delete_fragment_is_only_out_of_band(
    client, htmx, log_in, alice, bob, make_post, make_comment
):
    post = make_post(alice)
...
def test_post_delete_uses_hx_redirect(client, htmx, log_in, alice, make_post):
    post = make_post(alice)
    log_in("alice")
...
def test_follow_toggle_returns_the_button(client, htmx, log_in, alice, bob):
    log_in("bob")
...
def test_every_mutating_control_is_a_form_not_a_link(client, log_in, alice, bob, make_post):
...
def test_pages_reference_no_inline_javascript(client, log_in, alice, make_post):
